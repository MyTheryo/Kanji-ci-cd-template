...
const ThemeCustomizerSlice = createSlice({
  ...
  initialState: {
    layout: "compact-wrapper", // ConfigDB.data.settings.layout_class,
    mix_layout: "light", //ConfigDB.data.settings.mix_layout_type,
    layoutType: "ltr", // ConfigDB.data.settings.layout_type,
    sidebarIconType: "",
  },
  reducers: {
